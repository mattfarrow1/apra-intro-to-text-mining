...
The materials for this workshop are available in a cloud environment that can be run with no downloads or setup. All you need to is go to [posit.cloud](https://posit.cloud) and sign up for a free account. This page will be updated on Monday, August 28 prior to the workshop with the direct link to the workshop space.
...
Email: [matt.farrow\@childrens.com](mailto:matt.farrow@childrens.com)
