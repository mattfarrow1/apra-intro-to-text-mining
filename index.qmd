...
1.  Navigate to <https://github.com/mattfarrow1/apra-intro-to-text-mining>

2.  Click on the green "Code" button and copy the url under the HTTPS tab <https://github.com/mattfarrow1/apra-intro-to-text-mining.git>
