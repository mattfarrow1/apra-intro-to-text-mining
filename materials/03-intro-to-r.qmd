...
-   R needs to be installed before you can use RStudio
-   Download from CRAN (Comprehensive R Archive Network) [(link)](https://cran.r-project.org)
...
![](images/rstudio-import-1.png){fig-align="center" height="350"}

## Reading data into R

![](images/rstudio-import-2.png){fig-align="center" height="350"}

## Reading data into R

![](images/rstudio-import-3.png){fig-align="center" height="350"}
...
-   `CTRL or Command` + `Shift` + `M`

-   Can create complex operations by chaining functions together

-   Options for testing - highlight only intended section or comment out (`#)` lines
