...
`r fontawesome::fa("laptop-code", "black")` Open `03-intro-to-r/01-examine.R` in RStudio if you'd like to follow along.
...
By adding a dollar sign `$` after the name of our data, we can specify a single column.
